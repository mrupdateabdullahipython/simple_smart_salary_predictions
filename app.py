# app.py
# 💼 SalarySense AI - FINAL SAFE VERSION (Streamlit Cloud Ready)
...
theme = st.sidebar.selectbox("Theme", ["Dark Mode"])
...
st.caption("Built with Python • Streamlit • Machine Learning • Safe Version")